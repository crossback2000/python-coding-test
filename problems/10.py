# 실행: python 10.py < input.txt
"""
문제
중복 제거하기
- 정수 배열이 주어질 때, 등장 순서를 유지하며 중복되지 않는 원소만 출력한다. 집합과 리스트를 함께 사용하는 기초적인 자료구조 문제다.
...
해설
이미 본 숫자를 집합에 기록하면서, 처음 등장한 숫자만 결과 리스트에 추가한다. 입력 크기가 작아도 기본적인 "방문 기록" 패턴을 익힐 수 있다.
