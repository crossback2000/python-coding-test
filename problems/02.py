# 실행: python 02.py < input.txt
"""
문제
세 수 중 최댓값 찾기
- 세 정수 A, B, C가 주어질 때 가장 큰 값을 출력한다. 조건문과 비교 연산을 익히기 위한 쉬운 연습 문제다.

입력
한 줄에 세 정수 A, B, C가 공백으로 주어진다.
...
해설
내장 함수 ``max``를 사용하거나 비교 연산으로 직접 갱신해도 된다. 여기서는 로직을 읽기 쉽게 max 함수를 사용한다.
"""
